...
*  @date 2023/03/02
*  @return 
*  @param url : server url, data : 전송 데이터(json), type = post(default)/get
**/
function xhr_palin(url, data, dataType="text", async=true, type="POST") {
return $.ajax({
url: url,
data : data,
type: type,           
...
*  @date 2023/03/02
*  @return 
*  @param url : server url, data : 전송 데이터(formdata), type = post(default)/get
**/
function xhr_multipart(url, formdata, dataType="text", async=true, type="POST") {
    return $.ajax({
    url: url,
    data : formdata,
    type: type,           
