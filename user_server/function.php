...
function createIndexFile($json_data){
  ...
  **/
  ...
  $stringData .= '<script src="https://dev.additcorp.com/webzine_make/webzine_js/api.js"></script>';
  $stringData .= '<script src="https://dev.additcorp.com/webzine_make/webzine_js/const.js"></script>';
  $stringData .= '<script src="https://dev.additcorp.com/webzine_make/webzine_js/draw.js"></script>';
  $stringData .= '<script src="https://dev.additcorp.com/webzine_make/webzine_js/click.js"></script>';
  $stringData .= '<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css"/>';
  $stringData .= '<link rel="stylesheet" href="https://dev.additcorp.com/webzine_make/css/reset.css">';
  $stringData .= '<link rel="stylesheet" href="https://dev.additcorp.com/webzine_make/customer_css/style.css">';
  ...
  $stringData = $stringData . "<main class='mb-20 md:mb-40' id='banner'></main><article id='content'></article><footer id='footer'></footer>";


  $stringData .= '<script src="https://dev.additcorp.com/webzine_make/webzine_js/load.js"></script>';
...
function createSubFile($json_data){
  ...
  **/
  ...
  $stringData .= '<script src="https://dev.additcorp.com/webzine_make/webzine_js/sub_load.js"></script>';
  $stringData = $stringData . "</body></html>";
